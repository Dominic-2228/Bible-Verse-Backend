# Generated by Django 5.2.5 on 2025-09-04 16:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bibleBookId', models.CharField(max_length=10)),
                ('bibleChapterId', models.IntegerField()),
                ('bibleVerseId', models.IntegerField()),
                ('feelingId', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_likes', to='Backend.post')),
